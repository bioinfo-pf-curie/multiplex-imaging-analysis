process computeMasks {
  ...
  // label 'extraMem'
  memory {params.segmentation.name == 'cellpose'? NFTools.computeRoundedMemoryGb(meta.flowSize * 2, task.attempt, params.minMemory, params.maxMemory) : Math.min(params.maxMemory.size, (128.GB).getBytes())
  }
